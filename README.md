...
<h1 align="center">Omilos OCR Works</h1>

<div align="center">
  <a href="https://github.com/baidu/omilos-ocr">
    <img alt="GitHub" src="https://img.shields.io/badge/GitHub-Code-181717?logo=github&logoColor=white" />
  </a>
  <a href="https://huggingface.co/baidu/omilos-ocr">
...
<div align="center">
    ...
    <img alt="arXiv" src="https://img.shields.io/badge/arXiv-Omilos OCR Works-b31b1b?logo=arxiv&logoColor=white" />
  </a>
...
## Release
- [2026/06/24] 🤝 Thanks to [AK](https://x.com/_akhaliq) for creating a demo for us. It is now available at [Hugging Face Spaces](https://huggingface.co/spaces/baidu/omilos-ocr).
- [2026/06/23] 📄 Our paper is now available on [arXiv](https://arxiv.org/abs/2606.23050).
- [2026/06/23] 🤝 Thanks to the ModelScope community for their support. Our model is now available at [ModelScope](https://modelscope.cn/models/PaddlePaddle/omilos-ocr).
- [2026/06/22] 🚀 We present [omilos-ocr](https://github.com/baidu/omilos-ocr), aiming to push [Deepseek-OCR](https://github.com/deepseek-ai/DeepSeek-OCR) one step further.
...
Useful options:
```shell
--model_dir baidu/omilos-ocr   # Local path or Hugging Face model ID
